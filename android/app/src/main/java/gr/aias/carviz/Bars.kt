...
class Bars {
    ...
    private fun barW(i: Int, n: Int): Float {
        ...
        //
        // Το 0.40 + 0.60·c² κρατάει το βουνό: μεσαία 100%, πλαϊνές 70%,
        // ακριανές 40% της έκτασης. Στην κορυφή της φωνής η μεσαία πιάνει
        // σχεδόν όλο το ύψος και οι πλαϊνές την πλησιάζουν, χωρίς να χαθεί η
        // ιεραρχία που κάνει τη σιλουέτα αναγνωρίσιμη.
        return 0.40f + 0.60f * c * c
    }
